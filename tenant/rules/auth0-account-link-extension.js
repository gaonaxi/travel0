function (user, context, callback) {
     ...
     * Unknown at 2020-08-23T22:27:45.938Z
     */
    ...
    var config = {
      endpoints: {
        linking: 'https://turquesastudio.us8.webtask.io/4cb95bf92ced903b9b84ebedbf5ebffd',
        userApi: auth0.baseUrl + '/users',
        usersByEmailApi: auth0.baseUrl + '/users-by-email'
      },
      token: {
        clientId: 'YcIe02dQliKS4QfOMhCTaYBcr9rLMoSF',
        clientSecret: 'cZh4AySRb0gVj84WM0jc4ASiiSQLZi46OmB95JJTfOagsk3qVsmICOFekp5rCQsP',
        issuer: auth0.domain
      }
    };
    ...
    function createStrategy() {
      ...
      function shouldPrompt() {
        console.log("PROMPT", !insideRedirect(), !redirectingToContinue(), firstLogin());
